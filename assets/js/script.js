...
class LanguageManager {
  ...
  applyLanguage() {
    ...
    if (metaLanguage) {
      metaLanguage.content = this.currentLang === 'en' ? 'English' :
        this.currentLang === 'es' ? 'Spanish' :
          this.currentLang === 'fr' ? 'French' :
            this.currentLang === 'pt' ? 'Portuguese' :
              this.currentLang === 'de' ? 'German' :
                this.currentLang === 'it' ? 'Italian' :
                  this.currentLang === 'ja' ? 'Japanese' :
                    this.currentLang === 'zh' ? 'Chinese' :
                      this.currentLang === 'ru' ? 'Russian' : 'English';
    }
